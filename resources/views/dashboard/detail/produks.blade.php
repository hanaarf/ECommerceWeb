                  ...
                  <div class="row">
                    <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                      ...
                      <p class="card-title">Detail Product</p>
                        <h1 class="text-primary">{{ $produk->price }}</h1>
                        <h3 class="font-weight-500 mb-xl-4 text-primary"> {{ $produk->name }}</h3>
                        <img src="../../imgcdbry/{{ $produk->img }}" alt="image" width="250px" alt="" style="margin-left: -25px">
                        <p class="mb-2 mb-xl-0">produc desc : {{ $produk->desc }}</p>
                      </div>  
                      </div>
